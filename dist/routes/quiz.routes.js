...
const quizController = __importStar(require("../controllers/quiz.controllers"));
 ...
 *         description: Quiz not found
 */
router.patch("/:id", (0, auth_middleware_1.restrictTo)("instructor", "admin"), quizController.updateQuiz);
/**
 * @swagger
 * /quizzes/{id}:
 *   delete:
 ...
 *         description: Quiz not found
 */
router.delete("/:id", (0, auth_middleware_1.restrictTo)("instructor", "admin"), quizController.deleteQuiz);
/**
 * @swagger
 * /quizzes/analytics:
 *   get:
 ...
 */
router.get("/analytics", (0, auth_middleware_1.restrictTo)("instructor", "admin"), quizController.getAnalytics);
/**
 * @swagger
